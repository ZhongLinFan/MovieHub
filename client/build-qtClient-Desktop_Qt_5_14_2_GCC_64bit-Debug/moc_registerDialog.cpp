...
#include <memory>
#include "../qtClient/registerDialog.h"
...
QT_MOC_LITERAL(1, 15, 13), // "registerGroup"
QT_MOC_LITERAL(2, 29, 0), // ""
QT_MOC_LITERAL(3, 30, 9), // "groupName"
QT_MOC_LITERAL(4, 40, 7) // "summary"

    },
    "RegisterDialog\0registerGroup\0\0groupName\0"
    "summary"
};
...
void RegisterDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->registerGroup((*reinterpret_cast< const QString(*)>(_a[1])),(*reinterpret_cast< const QString(*)>(_a[2]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&RegisterDialog::registerGroup)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void RegisterDialog::registerGroup(const QString & _t1, const QString & _t2)
{
